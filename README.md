...
Определите какие модели нужны для работы сервера. Скорее всего это будут модели типа `Category`, `Posts` и `Comment`. Подумайте как эти модели связаны между собой. Какой тип связи между ними существует: один к одному, один ко многим или многие ко многим? Проконсультируйтесь с наставником, чтобы понять правильно ли вы определили модели и связи.
